...
extern LONG pupos;	/* Hashed symbol value of user_pos_cover/1 */
extern LONG puneg;	/* Hashed symbol value of user_neg_cover/1 */
extern LONG pusz;	/* Hashed symbol value of user_hyp_size/1 */
extern LONG inflate;	/* Example inflation (%) */
extern LONG cthresh;	/* Compression threshold */
extern double prooflengths; /* Sum -log(p(proof(ei))) */
...
extern ITEM labels;	/* Labels for SLPs */
extern ITEM sumlabels;	/* Summed labels for SLP defns */
extern ITEM vcall1;	/* Call for single arg predicate */
extern ITEM ptog;	/* psym -> generator-psym */
extern ITEM hypothesis;	/* A clause */
extern ITEM call1,hyp1;	/* Hypothesis being tested */
extern PREDICATE negq1;	/* Hypothesis is integrity constraint? */
extern double noiselim,clim,fnex1;
